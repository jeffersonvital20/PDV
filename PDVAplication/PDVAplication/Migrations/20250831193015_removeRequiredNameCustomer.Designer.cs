...
namespace PDVAplication.Migrations
{
    ...
    [Migration("20250831193015_removeRequiredNameCustomer")]
    partial class removeRequiredNameCustomer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PDVAplication.Domain.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PDVAplication.Domain.Model.SalesModel", b =>
                {
                    ...
                    b.Property<DateTime>("SalesEndteDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("SalesUpdateDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PDVAplication.Domain.Model.ApplicationUser", null)
                        .WithMany()
